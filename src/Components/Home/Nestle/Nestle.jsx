...
const Nestle = () => {
  ...
  const Chineseproducts = isRestaurantData
  ?.flatMap((restaurant) =>
...
console.log("Chinese products Data:", Chineseproducts);
  ...
  return (
    <div className="max-w-7xl mx-auto min-h-screen mb-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-4 px-6 lg:px-4">
        {Chineseproducts.length > 0 ? (
          Chineseproducts.map((food, index) => ( // ✅ Fixed `Chineseproducts.products`
