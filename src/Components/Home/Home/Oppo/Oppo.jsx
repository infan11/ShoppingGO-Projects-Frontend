...
const Oppo = () => {
  ...
  const Burgerproducts = isRestaurantData
    ?.flatMap((restaurant) =>
  ...
  console.log("Burger products Data:", Burgerproducts);
  ...
  return (
    <div className="max-w-7xl mx-auto min-h-screen mb-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-4 px-6 lg:px-4">
        {Burgerproducts.length > 0 ? (
          Burgerproducts.map((food, index) => ( // ✅ Fixed `Burgerproducts.products`
