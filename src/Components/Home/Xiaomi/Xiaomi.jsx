...
const Xiaomi = () => {
  ...
  const [existingItem, setExistingItem] = useState(false);
    const Juiceproducts = isRestaurantData
    ?.flatMap((restaurant) =>
  ...
  console.log("Juice products Data:", Juiceproducts);
  ...
  return (
    <div className="max-w-7xl mx-auto min-h-screen mb-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-4 px-6 lg:px-4">
        {Juiceproducts.length > 0 ? (
          Juiceproducts.map((food, index) => ( // ✅ Fixed `Juiceproducts.products`
